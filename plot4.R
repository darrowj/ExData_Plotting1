...
plot(powerDateTime, subPowerConsum$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex.lab=.75, cex.axis=.75)

plot(powerDateTime, subPowerConsum$Voltage, type="l", xlab="datetime", ylab="Voltage", cex.lab=.75, cex.axis=.75)

plot(powerDateTime, subPowerConsum$Sub_metering_1, type="l", ylab="Energy Submetering", xlab="", cex.lab=.75, cex.axis=.75)
...
plot(powerDateTime, subPowerConsum$Global_reactive_power, type="l", xlab="datetime", ylab="Global Reactive Power", cex.lab=.75, cex.axis=.75)
